...
object GameData {
    ...
    val ACHIEVEMENTS: List<Achievement> = listOf(
        Achievement("first_bite", "First Bite 🍎", "Eat your first food.", "😋"),
        Achievement("half_century", "Half Century 🥉", "Reach 50 points in one game.", "🥉"),
        Achievement("century", "Centurion 💯", "Reach 100 points in one game.", "💯"),
        Achievement("snake_master", "Snake God 👑", "Reach 300 points in one game.", "👑"),
        Achievement("score_500", "Viper Lord 🐉", "Reach 500 points in one game.", "🐉"),
        Achievement("score_1000", "Slytherin Emperor 💀", "Reach a legendary score of 1000 points!", "💀"),
        Achievement("blue_magic", "Blue Sorcerer 🧪", "Eat a Magical Blue Booster.", "🧪"),
        Achievement("star_power", "Star Catcher ⭐", "Eat a Golden Star.", "⭐"),
        Achievement("spicy_run", "Spicy Runner 🌶️", "Eat a Spicy Chili and run fast.", "🔥"),
        Achievement("chili_crying", "Spicy Tears 😭", "Cry funny chili tears for 10 seconds.", "😭"),
        Achievement("magnet_pull", "Magneto 🧲", "Activate magnetic force pull.", "🧲"),
        Achievement("immortal_ghost", "Ghost Mode 👻", "Activate ghost immortality.", "👻"),
        Achievement("shrink_master", "Mini Snake 🍄", "Eat a Shrink Shroom to shrink length.", "🤏"),
        Achievement("hungry_slitherer", "Voracious Eater 🍔", "Eat 30 foods in a single run.", "🍔"),
        Achievement("double_deal", "Double Jackpot 💎", "Eat food while Double Points is active.", "💎"),
        Achievement("perfect_reflexes", "Speed Demon ⚡", "Control the snake under Hyper Speed.", "⚡"),
        Achievement("combo_king", "Combo Master 🔥", "Reach an 8x combo multiplier!", "💥"),
        Achievement("all_skins", "Fashionista 👗", "Play with at least 3 different skins.", "🎭"),
        Achievement("skin_collector", "Skin Collector 🎭", "Play with at least 6 different skins.", "🕶️"),
        Achievement("level_clear", "Level Explorer 🗺️", "Complete Level 1 in Level Mode.", "🏆"),
        Achievement("level_3_master", "Viper Hunter 🗺️", "Complete Level 3 in Level Mode.", "🛡️"),
        Achievement("volcano_conqueror", "Volcano Conqueror 🌋", "Survive Level 4 in Level Mode.", "🌋"),
        Achievement("cyber_god", "Cyber Legend 🌌", "Complete Level 5 and beat the grid.", "🌌")
    )
